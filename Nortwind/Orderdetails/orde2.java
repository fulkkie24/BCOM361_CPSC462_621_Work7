...
String[] fields;
String patternStr = ",";
FileReader fin = new FileReader("data_Orderdetails.dat");
BufferedReader bin = new BufferedReader (fin);
FileOutputStream fout = new FileOutputStream("orde.htm");
BufferedOutputStream bout = new BufferedOutputStream(fout);
PrintStream pout = new PrintStream(bout);
pout.println("<center><body bgcolor=white><table border=1 width=80%>");
pout.println("<tr bgcolor=#D0ECE7 align=center><td>No</td><td>orderid</td><td>productid</td><td>unitprice </td><td>quantity</td><td>cate</td></tr>");
