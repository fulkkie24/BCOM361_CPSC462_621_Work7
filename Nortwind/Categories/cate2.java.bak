...
String[] fields;
String patternStr = ",";
FileReader fin = new FileReader("data_categories.dat");
BufferedReader bin = new BufferedReader (fin);
FileOutputStream fout = new FileOutputStream("cate.htm");
BufferedOutputStream bout = new BufferedOutputStream(fout);
PrintStream pout = new PrintStream(bout);
pout.println("<center><body bgcolor=white><table border=1 width=80%>");
pout.println("<tr bgcolor=#D0ECE7 align=center><td>No</td><td>categoryid</td><td>Name</td><td>description</td><td>Price</td></tr>");
