...
String[] fields;
String patternStr = ",";
FileReader fin = new FileReader("data_customers.dat");
BufferedReader bin = new BufferedReader (fin);
FileOutputStream fout = new FileOutputStream("cus.htm");
BufferedOutputStream bout = new BufferedOutputStream(fout);
PrintStream pout = new PrintStream(bout);
pout.println("<center><body bgcolor=white><table border=1 width=80%>");
pout.println("<tr bgcolor=#D0ECE7 align=center><td>No</td><td>customerid</td><td>companyname</td><td>contactname</td><td>contacttitle</td></tr>");
